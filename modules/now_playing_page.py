...
from modules.download_button import _DownloadButton
from modules.icons import accent_icon, icon
from modules.np_lyrics import _LyricsCache, _LyricsMixin, _ScrollbarFader
from modules.np_track_list import _TrackDelegate, _TracksListView, _TracksModel
...
class NowPlayingPage(_LyricsMixin, QWidget):
