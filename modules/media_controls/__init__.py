...
from modules.platform_compat import IS_LINUX

if IS_LINUX:
    try:
        from modules.media_controls._mpris import MprisService as _Backend
    except Exception:
        from modules.media_controls._unsupported import (
