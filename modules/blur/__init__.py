...
See modules/theme.body_color_for() and docs/research/portable_blur.md.
...
if sys.platform.startswith("linux"):
    ...
    from modules.blur import _dwm as _backend
elif sys.platform == "darwin":  # pragma: no cover - exercised on macOS
    from modules.blur import _macos as _backend
