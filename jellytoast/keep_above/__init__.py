...
# MAIN_WINDOW_TITLE → jellytoast/app.py. The main window's rule uses an
...
if is_kde_wayland():
    from jellytoast.keep_above import _kwin as _backend
else:
    from jellytoast.keep_above import _unsupported as _backend
