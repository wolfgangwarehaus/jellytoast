...
def _paint_progress_ring(
    ...
    from jellytoast.icons import ICON_ACCENT
...
def _paint_corner_button(
    ...
    *,
    ...
    from jellytoast.icons import ICON_ACCENT, ICON_BRIGHT, _svg_pix
...
class _LibraryListView(QListView):
    ...
    def __init__(self, tile_delegate: _TileDelegate, row_delegate: _RowDelegate, parent=None):
        ...
        from jellytoast.keyboard_focus import register_keyboard_mode_view
    ...
    def _on_entered(self, idx: QModelIndex):
        ...
        if kind == "album":
            ...
            if url:
                from jellytoast.ui_helpers import load_image_async
