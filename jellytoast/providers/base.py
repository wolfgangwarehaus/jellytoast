...
``jellytoast.providers.jellyfin.JellyfinProvider`` and (later)
``jellytoast.providers.subsonic.SubsonicProvider`` plug in behind it.
...
class MediaProvider(ABC):
    ...
    def query_items(self, rules: Dict[str, Any]) -> List[Dict[str, Any]]:
        ...
        ``jellytoast.providers.smart_rule_schema`` — a flat list of
