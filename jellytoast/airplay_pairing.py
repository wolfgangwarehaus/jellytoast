...
Modal flow that drives ``jellytoast.airplay2.pair_begin_sync`` /
...
Both pairing primitives block, so they run via ``jellytoast.async_io.run_async``
...
from jellytoast.airplay2 import (
    AirPlay2Device,
    _PairingHandle,
    pair_begin_sync,
    pair_finish_sync,
...
class PairingDialog(QDialog):
    ...
    def _primary_button(self, text: str) -> QPushButton:
        ...
        from jellytoast.ui_helpers import ACCENT as _A
