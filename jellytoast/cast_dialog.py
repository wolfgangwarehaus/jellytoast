...
class CastDialog(QDialog):
    ...
    def __init__(self, cast_manager: CastManager, parent=None):
        ...
        from jellytoast.keep_above import CAST_DIALOG_WINDOW_TITLE
        ...
        from jellytoast.ui_helpers import GLOBAL_STYLE, body_color_tuple
        ...
        # persists in QSettings per type — see jellytoast.cast_dialog_sections.
    ...
    def _on_section_toggled(self, section_type: str, collapsed: bool):
        ...
        from jellytoast.cast_dialog_sections import write_collapsed
        from jellytoast.settings import get_settings
    ...
    def _apply_banner_qss(self):
        ...
        from jellytoast.theme import _hex_to_rgb as _hr
    ...
    def _reapply_accent(self):
        ...
        from jellytoast.ui_helpers import body_color_tuple
