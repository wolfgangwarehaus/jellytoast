...
schema in :mod:`jellytoast.providers.smart_rule_schema`. Each rule is a
...
Presets (defined in :mod:`jellytoast.smart_playlists.presets`) load as a
...
from jellytoast.providers.smart_rule_schema import FIELDS, VALID_MATCH, validate_rules
from jellytoast.selector import Selector, selector_qss
from jellytoast.smart_playlists.presets import PRESETS, YEAR_PRESET_NAME, make_year_preset
...
def _label(text: str, *, dim: bool = True) -> QLabel:
    ...
    # `from jellytoast.ui_helpers import TEXT_DIM` at module top freezes
...
class _RuleChip(QFrame):
    ...
    def __init__(self, parent: Optional[QWidget] = None, rule: Optional[Dict[str, Any]] = None):
        ...
        from jellytoast.ui_helpers import ink_alpha as _ink_alpha
        ...
        from jellytoast.ui_helpers import TEXT_DIM as _TEXT_DIM_RC
        ...
        from jellytoast.ui_helpers import TEXT as _TEXT_RM
        from jellytoast.ui_helpers import TEXT_DIM as _TEXT_DIM_RM
...
class SmartPlaylistEditorDialog(QDialog):
    ...
    def __init__(
        ...
        from jellytoast.keep_above import SMART_PLAYLIST_EDITOR_WINDOW_TITLE
        ...
        from jellytoast.ui_helpers import DIALOG_BODY_COLOR as _DIALOG_BODY_COLOR
        ...
        if self._hint_text:
            from jellytoast.ui_helpers import TEXT_DIM as _TEXT_DIM_HINT
    ...
    def _on_preset_changed(self) -> None:
        ...
        if name == YEAR_PRESET_NAME:
            ...
            from jellytoast.smart_playlists.presets import get_preset
...
def open_smart_playlist_editor(
    ...
    Args:
        ...
        preset_rules: a raw, schema-valid rules dict to pre-populate
            ...
            the ``jellytoast.smart_playlists.presets`` ``from_*`` factories.
